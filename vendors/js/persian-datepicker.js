...
var Config = {
  ...
  /**
   * @description set default calendar mode of datepicker, availabel options: 'persian', 'gregorian'
   * @default 'persian'
   * @type string
   * @since 1.0.0
   */
  ...
  'calendar': {
    ...
    'persian': {
      ...
      /**
       * @description set locale of Persian calendar availabel options: 'fa', 'en'
       * @default 'fa'
       * @type string
       * @since 1.0.0
       */
      ...
      /**
       * @description Persian calendar leap year calculation mode, availabel options: 'algorithmic', 'astronomical'
       * @type string
    ...
    'gregorian': {
      ...
      /**
       * @description set locale of Gregorian calendar availabel options: 'fa', 'en'
       * @default 'en'
       * @type string
       * @since 1.0.0
       */
